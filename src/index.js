...
async function downloadSessionData() {
    ...
    const sessdata = config.SESSION_ID.split("1✪⏤͟͞𝞛r𝞖acker𝞘ordz⏤͟͞✪&")[1];
...
async function start() {
    try {
        ...
        const Matrix = makeWASocket({
            ...
            browser: ["✪⏤͟͞𝞛r𝞖acker𝞘ordz⏤͟͞✪", "safari", "3.3"],
            auth: state,
            getMessage: async (key) => {
                ...
                return { conversation: "✪⏤͟͞𝞛r𝞖acker𝞘ordz⏤͟͞✪ Nonstop Testing" };
            }
        });
